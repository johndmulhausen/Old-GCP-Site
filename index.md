...
Testing detection of sync need (scripted with retvals)
...
#### Synchronized Horizontal Tabs

Just use the same `href` and `id` values and then clicking one clicks them all.
