(function() {
  ...
  $(document).ready(function() {
    ...
    $(window).scroll(function() {
      ...
      $($('.hadoop-top')).each(function(index) {

        var feature = $('.hadoop-top:eq(' + index + ')').attr('id');

        if (isScrolledIntoView('.hadoop-top:eq(' + index + ')') &&
          isNotInArray(feature))
        {
          reachedFeatures.push(feature);
          _gaq.push(['_trackEvent', 'HadoopScroll', 'ScrolledToSection_' +
